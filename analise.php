...
$message = "На сайте Таргет в форме =АНАЛИЗ= пользователь $name оставил свой телефон $tel для обратной связи." . "\n\n" . $_POST['message'];
...
echo "Сообщение из формы =АНАЛИЗ= отправлено. Спасибо Вам " . $first_name . ", мы скоро свяжемся с Вами.";
